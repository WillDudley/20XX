...
if __name__ == "__main__":
    ...
    """ ENV SETUP """
    env = Melee_v0.env([RandomFox(), CPUFox()], os.path.expanduser('~/.melee/SSBM.ciso'), fast_forward=True)
    env.start_emulator()
    num_agents = len(env.possible_agents)
    num_actions = env.action_space(env.possible_agents[0]).nvec.prod()
    ...
    for episode in range(total_episodes):
        ...
        with torch.no_grad():
            ...
            next_obs, infos = env.reset(melee.enums.Stage.FOUNTAIN_OF_DREAMS)
